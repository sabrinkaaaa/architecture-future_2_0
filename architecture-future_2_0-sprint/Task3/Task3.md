...
![Techradar](./docs/radar-1.png)
![Techradar](./docs/radar-2.png)

## 2. Roadmap

| Этап                                      | Период     | Основные действия                                                          | Результат                                  | Ответственные            | Ресурсы                |
| ----------------------------------------- | ---------- |----------------------------------------------------------------------------| ------------------------------------------ | ------------------------ | ---------------------- |
| **1. Инфраструктурное основание**         | Q1–Q2 2025 | Внедрение Terraform, Kubernetes, CI/CD, централизованной авторизации (IAM) | Унифицированная среда для сервисов         | DevOps Team              | Облако, лицензии CI/CD |
| **2. Доменное разделение**                | Q2–Q3 2025 | Выделение доменов Clinic, Fintech, AI, Реализация Data Mesh, Kafka,        | Независимое развитие направлений           | Архитектурная команда    | Kafka, DWH, DataOps    |
...
| **5. Масштабирование и внешние партнёры** | Q1 2026    | Интеграция Pharmaceutic и доугих новых доменов через API                   | Расширение экосистемы компании             | Partner Integration Team | API Gateway, SDK       |
