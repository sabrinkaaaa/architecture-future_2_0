...
| **Pharmaceutic**     | Фармакомпания (партнер) для поставки необходимых медикоментов | Названия, рег. номера, срок годности    | Поставка медикоментов для лечения пациентов       | Отдельные бизнес-процессы, граничающиеся с ФЗ РФ, требуюшие особого внимания              |
| **Laboratory**       | Лаборатория для проведения анализов и исследований            | Био-материалы, их токены                | Анализ био-материалов, исследование патологий     | Независимое развитие и направление, возможность гибкой интеграции с другими лабораториями |
| **WMS**              | Склад с товарами (поставка, выгрузка)                         | Товар, ID, номер поставки, данные учета | Выгрузка поступивших товаров, внутренний учет     | Отдельные бизнес-процессы, регулирование большого объема данных об учете                  |
...
| **AI System**        | Аналитика, прогнозирование, распознавание                     | Модели, датасеты, результаты вычислений | Диагностика, анализ медицинских изображений       | Отделение экспериментов и ML-пайплайнов от операционной логики                            |
